...
export default function DomicilioPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log('Sending domicilio request:', requestData)
      
      const response = await fetch('/api/domicilio-requests', {
        method: 'POST',
        headers: {
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-lg shadow-md p-8 mb-8">
            <h2 className="text-3xl font-bold text-primary-900 mb-6">
              Non hai tempo? Ti portiamo l'auto a casa
            </h2>
            <div className="prose prose-lg text-gray-700 space-y-4">
              <p>
                Se i tuoi impegni quotidiani ti impediscono di venirci a trovare nelle nostre strutture, siamo a tua completa disposizione per una visita a domicilio. Potrai vedere e provare l'auto che ti piacerebbe acquistare senza alcun impegno d'acquisto!
              </p>
              <p>
                Per prenotare il <strong>test drive a domicilio</strong> compila il form sottostante. Fisseremo un appuntamento e potrai effettuare la prova dove e quando vuoi tu. AUTOCAMB.IT ti aspetta a <strong>Sassari</strong>, <strong>Alghero</strong> ed <strong>Olbia</strong>.
              </p>
            </div>
          </div>
